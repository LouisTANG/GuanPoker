...
public class Dealer {
	...
	public static void deal(){
		...
		try {
			cg1 = new CardGroup(num, cg.getCards(), cg.getCardsLocation(),0,num);
			cg2 = new CardGroup(num, cg.getCards(), cg.getCardsLocation(),num,2*num);
			cg3 = new CardGroup(num, cg.getCards(), cg.getCardsLocation(),2*num,3*num);
		} catch (Exception e) {
