...
public class PlayCardLogic {
	...
	/**
	 * Judge the input sorted string represents a hand of pure pairs, threes, four.
	 * @param str String represents cards figure
	 * @param Mode 2 for pairs, 3 for three and 4 for four
	 * @return true if the give string is pure pairs, threes or four. Will be called by isPairs(), isThrees() and isFour().
	 */
	...
	/**
	 * Judge the input sorted string represents three cards plus one or two cards.
	 * @param str String represents cards figure
